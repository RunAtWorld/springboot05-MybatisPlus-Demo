...
public class GeneratorCustomTemplate {
    ...
    static String dbUrl =
        "jdbc:mysql://127.0.0.1/skyeyedb?useUnicode=true&characterEncoding=UTF-8" + "&allowMultiQueries=true";
    ...
    private static String projectSrcPath = "/mp-demo";
    ...
    private void generateByTablesWithInjectConfig(String packageName, String... tableNames) {
        ...
        new AutoGenerator().setGlobalConfig(config)
            ...
            .setPackageInfo(new PackageConfig().setParent(packageName).setModuleName(mouduleName).setController("controller").setEntity("entity"))
            .execute();
    }
